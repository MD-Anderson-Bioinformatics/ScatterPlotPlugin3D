...
THREEx.RendererStats	= function (){
	...
	container.style.cssText = 'width:180px;opacity:0.9;cursor:pointer';
	...
	msText.style.cssText = 'color:#f00;font-family:Helvetica,Arial,sans-serif;font-size:19px;font-weight:bold;line-height:15px';
	...
	for(var i = 0; i < nLines; i++){
		...
		msTexts[i].style.cssText = 'color:#f00;background-color:#311;font-family:Helvetica,Arial,sans-serif;font-size:19px;font-weight:bold;line-height:15px';
